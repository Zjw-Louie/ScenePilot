...
from scipy.spatial.transform import Rotation as R
import copy
from transformers import AutoProcessor, AutoModelForImageTextToText, PaliGemmaForConditionalGeneration, AutoModelForCausalLM, AutoTokenizer, Qwen2_5_VLForConditionalGeneration
...
def compute_pms_score(prompt, new_obj_desc):
    ...
    new_obj_desc = "" if new_obj_desc is None else str(new_obj_desc).strip().lower()
